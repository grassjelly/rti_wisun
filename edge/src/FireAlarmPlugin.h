...
#ifndef FireAlarmPlugin_1522294833_h
#define FireAlarmPlugin_1522294833_h
...
extern "C" {
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern RTIBool 
    FireAlarmPlugin_deserialize_key_sample(
        PRESTypePluginEndpointData endpoint_data,
        FireAlarm * sample,
        struct RTICdrStream *stream,
        RTIBool deserialize_encapsulation,
...
#endif /* FireAlarmPlugin_1522294833_h */
